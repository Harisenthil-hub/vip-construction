  ...
  return (
    <section id="vip-inspiration" className="py-10 sm:py-14 lg:py-16 bg-[#F8FAFC] text-slate-900 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Section Tag & Heading - Matching Project Design System */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 w-full flex flex-col justify-between space-y-4 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-4">
              {vipInspiration.pillars.map((pillar, idx) => {
                ...
                return (
                  <div 
                    key={idx} 
                    className={`bg-white border rounded-2xl p-3 sm:p-4 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group cursor-pointer flex flex-col justify-between ${
                      isHighlighted
            ...
            {/* Founder Quote Card - Matching Project Accent Style */}
