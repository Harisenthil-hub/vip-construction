        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mx-3 sm:mx-4 lg:mx-2">
          {data_container_1.map((service) => {
            ...
            return (
              <div
                key={service.id}
                className="p-4 sm:p-6 lg:p-7 group border border-solid rounded-xl border-text-muted/50 hover:border-secondary transition-all duration-300 ease-in-out  hover:shadow-[0_0_20px_rgba(212,175,55,0.25)]"
              >
                ...
                <h3 className="mb-1 text-xs sm:text-base font-bold">{service.heading}</h3>
