    ...
    <section id="services" className="bg-slate-50 py-10 sm:py-14 lg:py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="h2-heading mt-3 mb-2">Construction Solutions</h2>
          <p className="text-xs sm:text-sm text-slate-600 leading-relaxed max-w-xl mx-auto font-normal">
            Complete construction solutions from architectural planning and
            structural execution to interiors, renovation, and commercial
            complexes with engineering precision.
          </p>
        </div>
        ...
        {/* Active Content */}
        <div className="slide-up mt-6 sm:mt-8 rounded-2xl bg-white p-5 sm:p-8 shadow-lg border border-slate-200/80 overflow-hidden">
