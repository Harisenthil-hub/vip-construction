...
const ProjectHero = () => {
  return (
    <section className="relative min-h-0 sm:min-h-[70vh] md:min-h-[720px] flex items-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 py-10 md:py-16">
